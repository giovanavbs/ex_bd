...
-- ex 9 
-- colocar o str_to_date dentro da procedure 
select * from tbFornecedor;
...
delimiter &&
create procedure spinsertcompra(vNotaFiscal int, vNome varchar(200), vDataCompra char(10), vCodigoBarras numeric(14), vValorItem decimal(8,3), vQtdTotal int, vValorTotal decimal(8,2))
begin 
...
call spInsertCompra(10548, 'Amoroso e Doce', '10/09/2022', 12345678910111, 40.00, 100, 4000.00);
